...
<jsp:useBean id="PacienteConfirmado" class="com.bean.PacienteBean" scope="session" />
...
<title>Atención confirmada</title>
...
<body>
	...
	<div id="page" class="container">
		...
		<%= RPTACONF %> <%= PacienteConfirmado.getNombre() %> <%= PacienteConfirmado.getApellido() %>
		<br>
		<br>
		Para regresar a su menu click <a href="medicoPrincipal.jsp">aquí</a>
