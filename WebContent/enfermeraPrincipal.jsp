...
<title>Pagina Principal de Enfermera</title>
...
<div id="menu-wrapper">
	<div id="menu" class="container">
		<ul>
			<li class="current_page_item"><a href="enfermeraPrincipal.jsp">Inicio</a></li>
			<li><a href="enfermeraLoginPacienteParaRegistroManual.jsp">Peticion de Medicamento</a></li>
