...
/**
 * Servlet implementation class LoginPrevioaHistoriales
 */
public class LoginPrevioaHistoriales extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sesion.setAttribute("codigopaciente", cod);
		...
		if (!cod.equals("")){
			if (dao.validaUsuarioParaRegistroManual(cod)){
				...
				rd = request.getRequestDispatcher("/generalSelecciontipodeHistorial.jsp");
